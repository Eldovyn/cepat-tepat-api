...
@reset_password_router.post("/cepat-tepat/auth/reset-password/request")
...
@reset_password_router.get("/cepat-tepat/auth/reset-password/status/<string:token>")
...
@reset_password_router.get("/cepat-tepat/auth/reset-password/verify/<string:token>")
...
@reset_password_router.patch("/cepat-tepat/auth/reset-password/confirm/<string:token>")
